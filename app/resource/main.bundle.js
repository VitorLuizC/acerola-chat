...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_marked__ = __webpack_require__(2);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__html_js__ = __webpack_require__(0);
 ...
 */
const list = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__html_js__["a" /* getElement */])('.chat > .messages');

/**
 * Message field.
 * @type {HTMLTextAreaElement}
 */
const field = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__html_js__["a" /* getElement */])('.form > .message');
...
function renderMessage(message) {
  ...
  item.innerHTML = `
    ...
    ${__WEBPACK_IMPORTED_MODULE_0_marked___default.a.parse(message.text)}
  `;
...
function removeFirst() {
  let item = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__html_js__["a" /* getElement */])('li:first-child', list);
  list.removeChild(item);
}

/* harmony default export */ __webpack_exports__["a"] = { getMessage, renderMessage, removeFirst };
 ...
 */
const form = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__lib_html_js__["a" /* getElement */])('.form');

const field = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__lib_html_js__["a" /* getElement */])('.form > .message');
...
socket.on('chat message', message => {
  ...
  setTimeout(__WEBPACK_IMPORTED_MODULE_1__lib_chat_js__["a" /* default */].removeFirst, 30 * 1000);
});
...
function sendHandler(event) {
  ...
  let message = __WEBPACK_IMPORTED_MODULE_1__lib_chat_js__["a" /* default */].getMessage();
